  ...
  return (
    <>
      ...
      <div
        ...
        className="fixed bottom-20 left-4 z-50 w-72 rounded-lg border border-border bg-background shadow-2xl animate-in fade-in slide-in-from-bottom-2 duration-200"
      >
